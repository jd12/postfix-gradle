...
/**
 * An {@code Operator} is capable of performing an operation on some number
 * of {@link Operand}s.
 * @author jddevaug
 *
...
public interface Operator<T> {
	 ...
	 * @throws {@link IllegalStateException} if the required {@link Operand}s were not set. 
	 */
	 ...
	 * @throws {@link IllegalStateException} if the position was previously set.
	 * @throws {@link NullPointerException} if the operand provided is null.
	 */
