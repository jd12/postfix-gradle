...
public interface PostFixParser<T> {
	 ...
	 * @throws {@link IllegalStateException} if there are no more parsables.
	 */
	 ...
	 * @Throws {@link IllegalStateException} if the next parsable was not an Operand or there are no more parsables.
	 */
	 ...
	 * @Throws {@link IllegalStateException} if the next parsable was not an {@link Operator} or there are no more parsables.
	 */
